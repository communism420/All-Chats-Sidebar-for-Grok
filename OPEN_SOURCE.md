...
All Chats Sidebar for Grok is fully open-source software.
...
The project is released under the MIT License. Anyone may inspect, use, copy, modify, merge, publish, distribute, sublicense, or sell copies of the software under the conditions in `LICENSE`.

Contributions submitted to this repository are understood to be offered under the same MIT License unless explicitly agreed otherwise in writing.
